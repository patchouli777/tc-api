...
func (r *cache) get(ctx context.Context, id int) (*Category, error) {
...
func (r *cache) getByLink(ctx context.Context, link string) (*Category, error) {
...
func (r *cache) list(ctx context.Context, f CategoryFilter) ([]Category, error) {
...
func (r *cache) update(ctx context.Context, id int, upd CategoryUpdate) error {
	idStr := strconv.Itoa(id)
